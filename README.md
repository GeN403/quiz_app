...
## �ŐV�̃��[�J���N���菇�i�����m�F�ς݁j

�ȉ��� Docker ���g�킸�ɁAWindows ���[�J���ň��肵�ċN������菇�ł��B

### 1. �o�b�N�G���h�N���i`backend/venv` ���g�p�j
...
- ����: `.venv` �� `backend/venv` �����݂��Ă���ꍇ�́A`backend/venv` ��D�悵�Ă��������B

### 2. �t�����g�G���h�N���i`frontend` �z���Ŏ��s�j
...
- �t�����gURL: `http://localhost:3000`
- ����: `quiz_app` ���[�g�� `npm run dev` �����s����ƁA`pages/app directory` �G���[�ɂȂ�ꍇ������܂��B

### 3. �t�����g���o�b�N�G���h�ڑ���i���[�J���j

`frontend/.env.local` �Ɉȉ���ݒ肵�Ă��������B

```env
BACKEND_INTERNAL_URL=http://127.0.0.1:8000
```

- ���ݒ莞�̃f�t�H���g�� `http://127.0.0.1:8000` �ł����A�����ݒ�𐄏����܂��B
